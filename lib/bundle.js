...
/***/ (function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
	  var stage = new createjs.Stage("pokecanvas");
	
	  var manifest = [{ src: "sprites/pokeball.png", id: "pokeball" }, { src: "images/brick.jpg", id: "brick" }, { src: "images/PokeBounce.png", id: "logo" }, { src: "images/howToPlay.png", id: "howTo" }, { src: "images/startGame.png", id: "startGame" }, { src: "images/brickGreen.jpg", id: "brickGreen" }, { src: "images/brickPink.jpg", id: "brickPink" }, { src: "images/instructions.jpg", id: "instructions" }, { src: "images/congratulations.png", id: "congratulations" }, { src: "images/nextLevel.png", id: "nextLevel" }, { src: "images/start.png", id: "start" }, { src: "images/tryAgain.png", id: "tryAgain" }, { src: "images/gameOver.png", id: "gameOver" }, { src: "images/level1.png", id: "level1" }, { src: "images/level2.png", id: "level2" }, { src: "images/level3.png", id: "level3" }, { src: "images/level4.png", id: "level4" }, { src: "images/level5.png", id: "level5" }, { src: "images/level6.png", id: "level6" }, { src: "images/level7.png", id: "level7" }, { src: "images/level8.png", id: "level8" }, { src: "images/level9.png", id: "level9" }, { src: "images/level10.png", id: "level10" }, { src: "images/level11.png", id: "level11" }, { src: "images/level12.png", id: "level12" }, { src: "images/level13.png", id: "level13" }, { src: "images/level14.png", id: "level14" }, { src: "images/level15.png", id: "level15" }];
	  var loader = new createjs.LoadQueue(false);
	  loader.addEventListener("complete", showIntro);
	  loader.loadManifest(manifest, true, "./assets/");
	
	  function showIntro() {
	    var intro = new _intro2.default(stage, loader);
	    intro.render();
	  }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	  function Game(stage, loader) {
	    ...
	    var scoresFont = "400 16px Nunito";
	    var scoresColor = "#fff";
	  ...
	  _createClass(Game, [{
	    ...
	    value: function checkLose(board) {
	      if (this.lives <= 0) {
	        ...
	        board.end();
	        this.cumulativeScore += this.levelScore;
	        if (!localStorage.highScore || this.cumulativeScore > localStorage.highScore) {
	...
	var Board = function () {
	  ...
	  _createClass(Board, [{
	    ...
	    value: function buildWall(e) {
	      if (e.button === 0 && typeof this.buildPink === "string" && typeof this.buildGreen === "string") {
	...
	var SubDivFiller = function () {
	  ...
	  _createClass(SubDivFiller, [{
	    ...
	    value: function isWall(pos) {
	      if (pos[0] < 20 || pos[0] > 600 || pos[1] < 40 || pos[1] > 380) return true;
	...
	var LevelStart = function () {
	  ...
	  _createClass(LevelStart, [{
	    ...
	    value: function render(board) {
	      var levelText = new createjs.Bitmap(this.loader.getResult('level' + this.level));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var GameOver = function GameOver(score, stage, loader) {
	  ...
	  var gameOver = new createjs.Bitmap(loader.getResult('gameOver'));
