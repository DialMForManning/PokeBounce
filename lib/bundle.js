...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ...
	  var manifest = [{ src: "sprites/pokeball.png", id: "atom" }, { src: "images/brick.jpg", id: "brick" }, { src: "images/PokeBounce.png", id: "logo" }, { src: "images/howToPlay.png", id: "howTo" }, { src: "images/startGame.png", id: "startGame" }, { src: "images/brickGreen.jpg", id: "brickGreen" }, { src: "images/brickPink.jpg", id: "brickPink" }, { src: "images/instructions.jpg", id: "instructions" }];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	  function Game(stage, loader) {
	    ...
	    this.levelScore = 0;
	    this.levelStarter = new _level_start2.default(this.stage);
	    this.renderScoreBoard = this.renderScoreBoard.bind(this);
	    this.startNextLevel = this.startNextLevel.bind(this);
	    this.calculateAreaCaptured = this.calculateAreaCaptured.bind(this);
	  ...
	  _createClass(Game, [{
	    ...
	    value: function checkWin(board) {
	      if (this.areaCaptured >= 75) {
	        board.end();
	        new _win2.default(this.stage, this.startNextLevel);
	      }
	    }
	  }, {
	    key: 'checkLose',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = function () {
	  ...
	  _createClass(Board, [{
	    ...
	    key: 'render',
	    value: function render(numAtoms) {
	      var _this = this;
	      ...
	      for (var a = 0; a < numAtoms; a++) {
	        this.atoms.push(new _atom2.default(this.START_POS[a], this.game.loader.getResult("atom"), a));
	      }
	      ...
	      this.atoms.forEach(function (atom) {
	        _this.stage.addChild(atom.body);
	      });
	    ...
	    value: function checkWallCollisions(atom, walls) {
	      var _this2 = this;
	    ...
	    key: 'wallBounce',
	    value: function wallBounce(atom, vInd) {
	      atom.vel[vInd] *= -1;
	      atom.updatePos();
	    }
	  }, {
	    ...
	    value: function tick(event) {
	      ...
	      this.atoms.forEach(function (atom) {
	        _this4.checkWallCollisions(atom, Object.keys(_this4.walls).map(function (wallPos) {
	          return _this4.walls[wallPos];
	        }));
	        _this4.checkWallCollisions(atom, _this4.pinks);
	        _this4.checkWallCollisions(atom, _this4.greens);
	        atom.updatePos();
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SubDivFiller = function () {
	  function SubDivFiller(board) {
	    ...
	    this.findSubDivs = this.findSubDivs.bind(this);
	    this.compileSubDiv = this.compileSubDiv.bind(this);
	    this.neighbors = this.neighbors.bind(this);
	    this.fillSubDivs = this.fillSubDivs.bind(this);
	  ...
	  _createClass(SubDivFiller, [{
	    ...
	    value: function fillSubDivs() {
	      var that = this;
	      this.board.atoms.forEach(function (atom) {
	        var atomPos = [Math.floor(atom.body.x / 20) * 20, Math.floor(atom.body.y / 20) * 20].join();
	
	        Object.keys(that.subDivs).forEach(function (divNum) {
	          if (that.subDivs[divNum].includes(atomPos)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameOver = function GameOver(score, stage, loader) {
	  ...
	  var tryAgain = new createjs.Text();
...
/***/ function(module, exports) {
	...
	var Win = function Win(stage, startNextLevel) {
	  _classCallCheck(this, Win);
	
	  this.startNextLevel = startNextLevel;
	
	  var congrats = new createjs.Text();
	  ...
	  var nextLevel = new createjs.Text();
